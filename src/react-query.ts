...
export const REACT_QUERY_OPTIONS_TYPE_BY_HOOK_NAME: Record<ReactQueryHookName, string> = {
  [REACT_QUERY_QUERY_HOOK_NAME]: REACT_QUERY_DEFINED_INITIAL_DATA_OPTIONS,
  [REACT_QUERY_MUTATION_HOOK_NAME]: 'UseMutationOptions',
  [REACT_QUERY_INFINITE_QUERY_HOOK_NAME]: REACT_QUERY_DEFINED_INITIAL_DATA_INFINITE_OPTIONS,
};

export const REACT_QUERY_OPTIONS_FN_BY_HOOK_NAME: Record<Exclude<ReactQueryHookName, typeof REACT_QUERY_MUTATION_HOOK_NAME>, string> = {
  [REACT_QUERY_INFINITE_QUERY_HOOK_NAME]: REACT_QUERY_INFINITE_QUERY_OPTIONS_NAME,
  [REACT_QUERY_QUERY_HOOK_NAME]: REACT_QUERY_QUERY_OPTIONS_NAME,
};
